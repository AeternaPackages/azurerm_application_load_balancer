...
module "application_load_balancers" {
  source                     = "git::https://github.com/AeternaModules/azurerm_application_load_balancer.git?ref=v5.0.0"
  application_load_balancers = local.application_load_balancers
}

module "application_load_balancer_frontends" {
  source                              = "git::https://github.com/AeternaModules/azurerm_application_load_balancer_frontend.git?ref=v5.0.0"
...
module "application_load_balancer_security_policies" {
  source                                      = "git::https://github.com/AeternaModules/azurerm_application_load_balancer_security_policy.git?ref=v5.0.0"
...
module "application_load_balancer_subnet_associations" {
  source                                        = "git::https://github.com/AeternaModules/azurerm_application_load_balancer_subnet_association.git?ref=v5.0.0"
